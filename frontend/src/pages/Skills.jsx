            ...
            <div className="flex flex-col gap-6">
              {category.skills.map((skill) => (
                <motion.div
                  ...
                  // New hover animation for the entire skill bar
                  whileHover={{
                    scale: 1.02,
                    boxShadow: "0 4px 10px rgba(0,0,0,0.1)",
                  }}
                  className="flex items-center gap-4 p-4 rounded-lg bg-gray-200/50 dark:bg-gray-800/50 backdrop-blur-md shadow-md transition-all duration-300 cursor-pointer"
                >

      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="fixed inset-0 z-40 h-screen bg-gradient-to-br from-blue-100/80 via-white/90 to-blue-200/80 dark:from-blue-950/90 dark:via-gray-900/95 dark:to-blue-900/80 backdrop-blur-2xl flex flex-col items-center justify-center md:hidden"
          >
            <motion.button
              onClick={toggleMenu}
              whileHover={{ scale: 1.15 }}

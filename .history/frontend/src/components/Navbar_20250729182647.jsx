...
const Navbar = ({ theme, toggleTheme }) => {
  ...
  return (
    // Navbar background and text colors, with smooth transition
    <nav className="bg-gray-800 dark:bg-neutral-200 p-4 shadow-lg sticky top-0 z-50 transition-colors duration-500">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <Link
          to="/"
          // Adjusted dark:text-neutral-900 for better contrast in light mode
        ...
        <div className="hidden md:flex items-center space-x-6">
          {navLinks.map((link) => (
            <Link
              key={link.name}
              to={link.path}
              // Adjusted dark:text-neutral-800 and dark:hover:text-blue-500

...
const Footer = ({ theme }) => {
  ...
  return (
    ...
    <footer className="bg-gray-800 dark:bg-neutral-200 p-6 text-gray-400 dark:text-neutral-700 text-center text-sm mt-8">
      <div className="container mx-auto">
        ...
        <p className="mt-4 text-xs dark:text-neutral-600">Built with React, Node.js, Express, MongoDB & Tailwind CSS</p>
      </div>
    </footer>
  );
};

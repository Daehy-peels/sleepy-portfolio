          ...
          {navLinks.map((link) => (
            <Link
              ...
              className={`
                ...
                ${location.pathname !== link.path ? 'text-gray-300 dark:text-neutral-700' : ''}
                ...
                ${location.pathname !== link.path ? 'group-hover:before:scale-100' : ''}
              `}
            >
          ...
          {navLinks.map((link) => (
            <Link
              ...
              className={`group // Added group class for mobile links too
                         ...
                         ${location.pathname !== link.path ? 'text-gray-200 dark:text-neutral-800' : ''}
                         ...
                         // IMPORTANT: For mobile, the `group-hover` on text color might conflict if a blue fill is used.
                         // Let's make mobile hover effect simpler and just use the background/shadow hover, not the full fill effect
                         // to avoid overcrowding. The existing 'group-hover:bg-gray-600' is good.
                         // If you specifically want the "fill from center" on mobile too, let me know!
              `}
            >
              {link.name}
            </Link>

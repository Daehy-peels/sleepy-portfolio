...
const Navbar = ({ theme, toggleTheme }) => {
  ...
  return (
    {/* Changed dark:bg-gray-800 to dark:bg-neutral-200 */}
      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <button
            ...
            className="p-2 rounded-full focus:outline-none
                       ...
                       text-yellow-400 dark:text-neutral-700 text-xl transition-colors duration-300" // Adjusted colors for toggle button
        ...
        <div className="md:hidden flex items-center space-x-4">
          ...
          <button
            ...
            className="text-white dark:text-neutral-900 focus:outline-none text-2xl" // Adjusted mobile menu button color

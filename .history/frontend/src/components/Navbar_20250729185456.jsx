  ...
  return (
    ...
    <nav className="bg-gray-800 dark:bg-neutral-200 p-4 shadow-lg sticky top-0 z-50 transition-colors duration-500">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <Link
          to="/"
          // Combined into single line for clarity. Adjusted dark:text-neutral-900.
        ...
        <div className="hidden md:flex items-center space-x-6">
          {navLinks.map((link) => (
            <Link
              key={link.name}
              to={link.path}
              // Combined into single line. Adjusted dark colors.
      ...
      {isOpen && (
        // Adjusted dark background and border colors
        <div className="md:hidden bg-gray-700 dark:bg-neutral-300 mt-2 rounded-md shadow-lg py-2 transition-all duration-300 ease-in-out">
          {navLinks.map((link) => (
            <Link
              ...
              // Adjusted dark text and hover colors

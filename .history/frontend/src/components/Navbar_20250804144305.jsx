  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50
                 ...
                 backdrop-blur-lg backdrop-saturate-150 /* Adjusted blur and saturation */
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="fixed inset-0 z-40 bg-gradient-to-br from-blue-100/90 via-white/95 to-blue-200/90 dark:from-blue-950/95 dark:via-gray-900/98 dark:to-blue-900/95 backdrop-blur-2xl flex flex-col items-center justify-center md:hidden"
          >
            <motion.button
              onClick={toggleMenu}
              whileHover={{ scale: 1.15 }}

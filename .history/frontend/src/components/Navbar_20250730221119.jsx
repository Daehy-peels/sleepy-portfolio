  ...
  return (
    <nav className="bg-gray-900 dark:bg-gray-100 p-4 shadow-lg sticky top-0 z-50 transition-colors duration-500">
      <div className="container mx-auto flex justify-between items-center">
        {/* Logo/Brand */}
        <NavLink to="/" className="text-xl font-bold text-blue-400 dark:text-blue-600 flex items-center space-x-2">
          <span className="text-2xl">✨</span> {/* Or your actual logo/dev icon */}
        ...
        <div className="hidden md:flex space-x-8">
          ...
          >
            Home
            <span className={`absolute bottom-0 left-1/2 w-0 h-0.5 bg-blue-400 dark:bg-blue-600 transform -translate-x-1/2 transition-all duration-300 ${isActive ? 'w-full' : 'group-hover:w-full'}`}></span>
          </NavLink>
          <NavLink
            to="/about"
            className={({ isActive }) =>

      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-2 lg:gap-6">
          <ul className="flex gap-2 lg:gap-6">
            <AnimatePresence> {/* For layoutId animations */}
              {navLinks.map((link) => (
                <li
                  key={link.name}
                ...
                >
                  <motion.div
                    whileHover={{ y: -2, textShadow: "0 2px 8px rgba(59, 130, 246, 0.6)" }} // Lift and text shadow on hover
          ...
          <div className="flex space-x-4 text-2xl ml-4"> {/* Added ml-4 for spacing */}
            <motion.a
          ...
          >
            <AnimatePresence mode="wait">
              {theme === "dark" ? ( // Check 'theme' prop here
                ...
                >
                  <MdDarkMode className="w-6 h-6 text-blue-600 dark:text-blue-400" /> {/* Use MdDarkMode for dark theme */}
                </motion.div>
              ) : (
                <motion.div
                  ...
                  transition={{ duration: 0.3, type: "spring" }}
                >
                  <MdLightMode className="w-6 h-6 text-yellow-500" /> {/* Use MdLightMode for light theme */}
                </motion.div>
              )}
            </AnimatePresence>
          </motion.button>
        ...
        {isOpen && (
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
            >
              <X className="w-7 h-7 text-blue-600 dark:text-blue-400" /> {/* Using X from lucide-react if you switch, otherwise FaTimes from react-icons/fa */}
            </motion.button>
                ...
                {navLinks.map((link) => (
                  ...
                  >
                    <Link
                      ...
                      whileHover={{ scale: 1.1, textShadow: "0 2px 8px rgba(59, 130, 246, 0.6)" }}
                      whileTap={{ scale: 0.97 }}
                    >
                      {link.name}
                    </Link>

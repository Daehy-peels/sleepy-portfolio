...
const Footer = ({ theme }) => {
  ...
  return (
    // Changed dark:bg-gray-800 to dark:bg-neutral-200 for light mode Footer background
    // Changed dark:text-gray-400 to dark:text-neutral-700
    // Added transition-colors duration-500 for smooth theme change
    <footer className="bg-gray-800 dark:bg-neutral-200 p-6 text-gray-400 dark:text-neutral-700 text-center text-sm mt-8 transition-colors duration-500">
      ...
      <div className="container mx-auto">
        ...
        {/* Changed text-xs to dark:text-neutral-600 */}

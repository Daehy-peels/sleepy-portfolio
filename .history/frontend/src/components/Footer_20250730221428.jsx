  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-4xl">
        ...
        {/* Social Icons */}
        <div className="mt-4 pt-4 border-t border-gray-700 dark:border-gray-300 flex justify-center space-x-6 md:space-x-8 text-3xl">
          {" "}
          {/* Adjusted border for new backgrounds */}
          <motion.a

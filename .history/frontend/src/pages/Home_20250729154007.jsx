...
import yourProfilePic from "../assets/your-profile-picture.jpg";
...
const Home = () => {
  ...
  const techIcons = [
    // Format: { icon: <IconComponent />, label: "Name", hoverClass: "text-color", glowColor: "color-value" }
    {
      icon: <DiMongodb />,
      label: "MongoDB",
      hoverClass: "hover:text-green-500",
      glowColor: "var(--color-green-500)",
    },
    {
      icon: <SiExpress />,
      label: "Express.js",
    ...
    },
    {
      ...
      glowColor: "var(--color-blue-400)",
    },
    {
      icon: <DiNodejsSmall />,
      label: "Node.js",
      hoverClass: "hover:text-green-600",
      glowColor: "var(--color-green-600)",
    },
  ];
          ...
          {techIcons.map((tech) => (
            <motion.a
              ...
              className={`text-gray-300 dark:text-gray-700 ${tech.hoverClass}
                         ...
                         hover:drop-shadow-[0_0_15px_${tech.glowColor}]`} /* Dynamic glow color */

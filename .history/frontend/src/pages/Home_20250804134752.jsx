      ...
      <div className="mt-16 w-full max-w-2xl px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 justify-items-center">
          ...
          >
            ...
            >
              <SiExpress size={80} className="text-blue-900 dark:text-white" />
            </motion.div>
            {/* CORRECTED CODE: Remove the duplicate className attribute */}
            <span className="mt-4 text-xl font-semibold text-blue-900 dark:text-white transition-colors">
              Express
            </span>
          </motion.div>

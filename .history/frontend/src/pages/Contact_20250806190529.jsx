...
const Contact = () => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/messages", {
        ...
        body: JSON.stringify({
          ...
          subject: formData.subject, // Make sure to send the subject
      ...
      if (response.ok) {
        ...
        setFormData({ name: "", email: "", subject: "", message: "" }); // Reset the subject field
      } else {
  ...
  const contactDetails = [
    // ... (your contactDetails array remains the same)
    {

...
const Home = () => {
  ...
  const glowColors = {
    ...
    express:
      "shadow-[0_0_15px_rgba(80,80,80,0.8)] dark:shadow-[0_0_20px_rgba(80,80,80,0.8)]",
    react:
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <motion.p
          ...
          // Changed text-black to text-gray-900 for consistency with app defaults
          className="text-lg md:text-2xl mb-12 text-gray-900 dark:text-gray-300"
        >
      ...
      <div className="mt-16 w-full max-w-2xl px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 justify-items-center">
          ...
          >
            ...
            <span
              // Changed text-black to text-gray-800 for consistency
              className="mt-4 text-xl font-semibold transition-colors text-gray-800 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-gray-200"
            >
              Express
            </span>
          </motion.div>

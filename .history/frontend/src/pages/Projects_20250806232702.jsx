        ...
        {projects.map((project) => (
          ...
          >
            <div className="relative overflow-hidden rounded-xl group">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-white bg-black/60 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">

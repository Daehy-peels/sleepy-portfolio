    ...
    >
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12 mt-12 md:mt-24">
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.3 }}
          // Add hover and tap animations here
          whileHover={{
            scale: 1.05,
            boxShadow: "0 0 25px rgba(59, 130, 246, 0.7)", // Blue glow on hover
          }}
          whileTap={{ scale: 0.95 }}
          className="relative w-64 h-64 md:w-80 md:h-80 flex-shrink-0 rounded-full overflow-hidden transition-all duration-300"
        >

...
const Home = () => {
  ...
  const techIcons = [
    { icon: <DiMongodb />, label: "MongoDB", hoverClass: "hover:text-green-500" },
    { icon: <SiExpress />, label: "Express.js", hoverClass: "hover:text-yellow-500" }, // Express is JS, so yellow/orange
    { icon: <DiReact />, label: "React.js", hoverClass: "hover:text-blue-400" },
    { icon: <DiNodejsSmall />, label: "Node.js", hoverClass: "hover:text-green-600" },
  ];

  return (
    <section id="home" className="py-20 flex flex-col items-center justify-center text-center relative overflow-hidden min-h-[calc(100vh-80px)] px-4 sm:px-6 lg:px-8"> {/* Added padding directly to section */}

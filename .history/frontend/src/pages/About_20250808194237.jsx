...
const About = () => {
  ...
  const personalInfo = [
    ...
    { label: "Phone", value: "+95 94-4802-3128" },
          ...
          <ul className="space-y-4">
            {personalInfo.map((info) => (
              <motion.li
                ...
                className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-2 rounded-md transition-all duration-300 hover:bg-gray-100 dark:hover:bg-gray-800"
              >

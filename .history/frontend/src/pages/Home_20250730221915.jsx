...
const Home = () => {
  ...
  const [shootingStars, setShootingStars /* cite: 1 */] = useState([]);
  ...
  return (
    <section
      id="home"
      // Key change: Use h-full and flex properties directly on the section
      // The parent <main> is flex-grow, so h-full here means it will take 100% of <main>'s height.
      // justify-center and items-center will then center the content vertically and horizontally within this full height.

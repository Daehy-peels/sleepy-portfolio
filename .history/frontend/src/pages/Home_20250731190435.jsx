...
const Home = () => {
  ...
  const NAVBAR_HEIGHT = 'XXpx';

  return (
    <section
      id="home"
      // Reverted to calc(100vh - NAV_HEIGHT) but applied directly to the Home section.
      // This is generally more robust for full-screen sections below a fixed header.
      // Assuming Navbar height is approx. 80px (you can fine-tune this value)
      className="flex flex-col items-center justify-center text-center relative overflow-hidden px-4 sm:px-6 lg:px-8"
      style={{ minHeight: "calc(100vh - 80px)" }} // Explicitly set minHeight
    >

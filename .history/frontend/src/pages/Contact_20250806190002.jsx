...
const Contact = () => {
  ...
  try {
    const response = await fetch("http://localhost:5000/api/messages", {
      ...
      body: JSON.stringify({
        senderName: formData.name, // The backend expects 'senderName'
        senderEmail: formData.email, // The backend expects 'senderEmail'
        message: formData.message, // The backend expects 'message'
      }),
    });

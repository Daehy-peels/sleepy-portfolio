...
const Home = () => {
  ...
  const text = "A dedicated MERN Stack Developer."; // New: Text for typing effect

  // New: Container for text animation
  ...
  // New: Variants for individual characters
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        {/* Changed from <motion.p> to <motion.div> to wrap characters */}
        <motion.div

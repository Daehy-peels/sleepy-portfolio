...
const Home = () => {
  ...
  return (
    <section
      id="home"
      // Changed min-h-[calc(100vh-80px)] to min-h-full to rely on flex-grow of parent <main>
      // The parent <main> in App.jsx has flex-grow, so min-h-full here makes it fill available space
      className="py-20 flex flex-col items-center justify-center text-center relative overflow-hidden min-h-full px-4 sm:px-6 lg:px-8"
    >

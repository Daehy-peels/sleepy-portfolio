...
const Home = () => {
  ...
  const glowColors = {
    ...
    express:
      // Light mode glow remains black, dark mode glow remains dark gray
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <motion.p
          ...
          // Changed to text-black for light mode
          className="text-lg md:text-2xl mb-12 text-black dark:text-gray-500"
        >
      ...
      <div className="mt-16 w-full max-w-2xl px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 justify-items-center">
          ...
          >
            ...
            <span
              // Changed to text-black for light mode
              className="mt-4 text-xl font-semibold text-black dark:text-gray-200 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors"
            >
              MongoDB
            </span>
          </motion.div>
          ...
          >
            ...
            >
              <SiExpress
                size={80}
                // Changed to text-black for light mode
                className="text-black dark:text-gray-"
              />
            </motion.div>
            <span
              // Changed to text-black for light mode
              className="mt-4 text-xl font-semibold transition-colors text-black dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-gray-200"
            >
              Express
            </span>
          </motion.div>
          ...
          >
            ...
            <span
              // Changed to text-black for light mode
              className="mt-4 text-xl font-semibold text-black dark:text-gray-200 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors"
            >
              React
            </span>
          </motion.div>
          ...
          >
            ...
            <span
              // Changed to text-black for light mode
              className="mt-4 text-xl font-semibold text-black dark:text-gray-200 group-hover:text-green-700 dark:group-hover:text-green-500 transition-colors"
            >
              Node.js
            </span>
          </motion.div>

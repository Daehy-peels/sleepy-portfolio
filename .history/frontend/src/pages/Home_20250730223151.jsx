...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const intervalId = setInterval(() => {
      setShootingStars((prev) => [...prev.slice(-4), generateNewShootingStar()]);
    }, 3000);
  ...
  return (
    <section
      id="home"
      // IMPORTANT: Replace 'XXpx' with the exact height of your Navbar from Step 1.
      className="flex flex-col items-center justify-center text-center relative overflow-hidden px-4 sm:px-6 lg:px-8"
      style={{ minHeight: 'calc(100vh - XXpx)' }} // <-- Update XXpx here
    >
      ...
      <motion.div
        // Re-added vertical padding here if desired, otherwise remove.
